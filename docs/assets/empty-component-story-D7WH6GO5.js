...
// src/package/components/element/empty-component/empty-component.ce.css
var empty_component_ce_default = "./empty-component.ce-JN7FIWX6.css";

// src/package/components/element/empty-component/empty-component.ce.js
var empty_component_ce_default2 = "./empty-component.ce-ONDMBG2S.js";

// src/package/components/element/empty-component/empty-component.jsx
var EmptyComponent = (props) => /* @__PURE__ */ u2("empty-component", { children: [
  /* @__PURE__ */ u2("template", { shadowrootmode: "open", children: [
    /* @__PURE__ */ u2("div", { children: "Component goes here" }),
    /* @__PURE__ */ u2("link", { rel: "stylesheet", type: "text/css", href: `${props.globals.assetUrlPrefix}/${empty_component_ce_default}` })
  ] }),
  /* @__PURE__ */ u2("script", { defer: true, src: `${props.globals.assetUrlPrefix}/${empty_component_ce_default2}` })
] });

// src/package/components/element/empty-component/empty-component-story.mdx
var frontmatter = {
  "navigation": {

...
// src/package/components/element/icon-button/icon-button-story.mdx
var frontmatter = {
  "navigation": {
    "heading": "IconButton",
    "parent": "Element"
  ...
  return u2(g, {
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        }), "Small button", u2(_components.span, {
          className: "hljs-tag",
          children: ["</", u2(_components.span, {
            className: "hljs-name",
            children: "IconButton"
      ...
      children: u2(_components.code, {
        ...
        }), "Medium button", u2(_components.span, {
          className: "hljs-tag",
          children: ["</", u2(_components.span, {
            className: "hljs-name",
            children: "IconButton"
      ...
      children: u2(_components.code, {
        ...
        }), "Large button", u2(_components.span, {
          className: "hljs-tag",
          children: ["</", u2(_components.span, {
            className: "hljs-name",
            children: "IconButton"

...
// src/assets/images/pexels-skyler-ewing-4596712.jpg
var pexels_skyler_ewing_4596712_default = "./pexels-skyler-ewing-4596712-L6IS27G5.jpg";

// src/package/components/topic/quote-topic/quote-topic-story.mdx
var frontmatter = {
  "navigation": {
    "heading": "QuoteTopic",
    "parent": "Topic"
    ...
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        children: [u2(_components.span, {
          ...
          className: "hljs-string",
          children: `'"Every time I thought I'`
        }), u2(_components.span, {
          className: "hljs-string",
          children: `'d got it made, it seemed the taste was not so sweet"'`
        }), "\n  ", u2(_components.span, {
          className: "hljs-attr",
          children: "image:"
        }), " ", u2(_components.span, {
      ...
      children: u2(_components.code, {
        ...
        children: [u2(_components.span, {
          ...
          className: "hljs-string",
          children: "'../../../assets/images/pexels-skyler-ewing-4596712.jpg'"
        }), "\n"]
      })
    }), "\n", u2(_components.pre, {
      children: u2(_components.code, {
      ...
      images: {
        topicImage: pexels_skyler_ewing_4596712_default
      },
      globals
    }), "\n", u2(_components.h2, {
      children: "Example"

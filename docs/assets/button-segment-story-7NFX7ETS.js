...
// src/package/components/navigation/button-segment/button-segment-story.mdx
var frontmatter = {
  "navigation": {
    ...
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        children: [u2(_components.span, {
          ...
          children: "import"
        }), " ceCss ", u2(_components.span, {
          className: "hljs-keyword",
          children: "from"
        }), " ", u2(_components.span, {
          className: "hljs-string",
          children: "'../navigation.ce.css'"
        }), "\n"]
      })
    }), "\n", u2(_components.pre, {
      children: u2(_components.code, {
        ...
        children: [u2(_components.span, {
          ...
          children: ["<", u2(_components.span, {
            ...
            className: "hljs-attr",
            children: "globals.assetUrlPrefix"
          }), "}/${", u2(_components.span, {
            className: "hljs-attr",
            children: "ceCss"
          }), "}`} />"]
      ...
      rel: "stylesheet",
      type: "text/css",
      href: `${globals.assetUrlPrefix}/${navigation_ce_default}`
    }), "\n", u2(ButtonSegment, {
      globals,
      pageUrl: "/demo-b",

...
// src/package/components/element/link.mdx
var frontmatter = {
  "navigation": {
    "heading": "link",
    "parent": "Element"
  ...
  return u2(g, {
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        }), "A paragraph with a ", u2(_components.span, {
          className: "hljs-tag",
          children: ["<", u2(_components.span, {
            className: "hljs-name",
            children: "a"
      ...
      children: ["A paragraph with a ", u2("a", {
        href: "#",
        children: "link"
      }), " inside."]
    }), "\n", u2(_components.h2, {
      ...
      children: u2(_components.code, {
        ...
        }), "Extra large text with an active ", u2(_components.span, {
          className: "hljs-tag",
          children: ["<", u2(_components.span, {
            className: "hljs-name",
            children: "a"
      ...
      variant: "xl",
      children: ["Extra large text with an active ", u2("a", {
        href: "#",
        class: "active",
        children: "link"
      }), " inside."]

...
// src/package/components/typography/heading.mdx
var frontmatter = {
  "navigation": {
    "heading": "Heading",
    "parent": "Typography"
  ...
  return u2(g, {
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        }), "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.", u2(_components.span, {
          className: "hljs-tag",
          children: ["</", u2(_components.span, {
            className: "hljs-name",
            children: "p"

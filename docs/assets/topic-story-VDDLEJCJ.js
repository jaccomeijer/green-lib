...
// src/package/components/topic/topic/topic-story.mdx
var frontmatter = {
  "navigation": {
    ...
    children: [u2(_components.h1, {
      ...
      children: u2(_components.code, {
        ...
        children: [u2(_components.span, {
          ...
          children: "import"
        }), " topicImage ", u2(_components.span, {
          className: "hljs-keyword",
          children: "from"
        }), " ", u2(_components.span, {
          className: "hljs-string",
      ...
      images: {
        topicImage: kai_dahms_97yTozZh7N8_unsplash_default
      },
      globals
    })]
  });
